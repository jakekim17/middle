 ...
 * 
 * Adapted for use in this project by Massimo Beatini 02/28/2004
 */
...
namespace Wow.Fx
{
    public class FtpClient
    {
        ...
        // defaults
        private string server = "wownetup.xst.kinxcdn.com";
        private string remotePath = ".";
        //private string username = "wowtvupload";
        //private string password = "Uploadwowtv123@!";
        //이미지 자동 퍼지를 지속적으로 사용하기 위해, 아래와 같이 FTP접속 계정이 변경되었습니다.[17.12.07 / 권희진]
        private string username = "wowtvimg";
        private string password = "Uploadwowtv123@!";
